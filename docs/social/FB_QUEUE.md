...
- **片**：`web/media/hero/fb_lobby_9x16.mp4`（1080×1920、20s、H.264、真機中裁＋AAC 實體音軌）
- **來源**：自 `web/media/hero/fb_lobby.mp4`（1280×720 橫式神殿黑曜石新大廳）中裁成 9:16，片頭疊「長按加速／數牠換了幾次姿勢」，含發條齒輪與互動音軌。
- **發法**（審過後）：`python3 /root/fb_post.py video "<文案>" web/media/hero/fb_lobby_9x16.mp4 "長按加速"`
- **誠實**：這是神殿黑曜石與古典黃金齒輪手遊大廳實機（主角小白、零毛皮、發條機械結構）。
...
中間那隻還會動的發條小白，20 秒內換了幾次姿勢？加速看完一遍，鬆手再數。留言只回一個數字。

這是真機實錄，不是概念圖。神殿黑曜石地坪、古典黃金齒輪、背後的發條鑰匙都在動。
...
3. **誠實**：無上架日、無商店；Day 2 為神殿黑曜石新大廳真機實錄。
