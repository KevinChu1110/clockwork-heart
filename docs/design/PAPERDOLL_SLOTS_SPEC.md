...
| **Slot 6** | `weapon` | **手持武器外觀** | Handheld Weapon Skin | `40` | 主手武器持握部、刃/槍頭/杖端、副手爪套/盾牌 | 獨立道具層，絕不與手臂焊死；玩具比例偏大，具厚實玩具質感與發條齒輪機關；支援 12 大武器體系。 | 晨曦發條單手長劍、機關發條靈爪護手、皇家突刺長矛、星盤晶核法杖、鍛爐鐵砧重錘 |
