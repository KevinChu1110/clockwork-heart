...
| `fox` (靈尾狐) | • `branding/char_fox.png` (400×840 立牌)<br>• `web/media/hero/char_fox.png` (400×840 官網英雄圖)<br>• `game/assets/sprites/player/party/fox_idle.png` (128×128)<br>• `game/assets/sprites/portraits/fox_mage.png` (對話框頭像)<br>• `game/assets/sprites/player/paperdoll/fox/` (7大部件切片) | • `web/media/hero/fox_idle.png` (128×128)<br>• `game/assets/sprites/player/fox_idle.png` (64×64)<br>• `game/assets/sprites/player/fox_battle.png` (128×128)<br>• `game/assets/sprites/player/fox_walk_{0..3}.png`<br>• `game/assets/sprites/player/poses/fox/`<br>• `game/assets/sprites/portraits/fox.png` (128×128 HUD) | 隊伍展示待機幀既存於 `party/` 目錄下；法師對話半身像既存於 `portraits/fox_mage.png`。 |
