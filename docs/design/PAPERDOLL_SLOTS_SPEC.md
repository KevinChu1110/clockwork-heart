...
| `lion` (烈鬃獅) | • `branding/char_lion.png` (400×840 立牌)<br>• `web/media/hero/char_lion.png` (400×840 官網英雄圖)<br>• `web/media/hero/lion_idle.png` (128×128 官網預覽圖)<br>• `game/assets/sprites/player/party/lion_idle.png` (128×128)<br>• `game/assets/sprites/player/lion_battle.png` (128×128)<br>• `game/assets/sprites/player/lion_walk_{0..3}.png` (64×64)<br>• `game/assets/sprites/player/lion_walk_{0..3}_x3.png` (128×128)<br>• `game/assets/sprites/player/poses/lion/` (6大戰鬥動作姿態目錄)<br>• `game/assets/sprites/portraits/lion.png` (128×128 HUD)<br>• `game/assets/sprites/portraits/lion_knight.png` (對話框頭像)<br>• `game/assets/sprites/player/paperdoll/lion/` (7大部件切片) | • `game/assets/sprites/player/lion_idle.png` (64×64) | 官網英雄預覽、隊伍展示幀、戰鬥特寫姿態、行走動畫、戰鬥6大動作姿態目錄與 HUD 戰鬥頭像已全數產出齊全。 |
...
| `boar` (鋼牙豕) | • `branding/char_boar.png` (400×840 立牌)<br>• `web/media/hero/char_boar.png` (400×840 官網英雄圖)<br>• `web/media/hero/boar_idle.png` (128×128 官網預覽圖)<br>• `game/assets/sprites/player/party/boar_idle.png` (128×128)<br>• `game/assets/sprites/player/boar_battle.png` (128×128)<br>• `game/assets/sprites/player/boar_walk_{0..3}.png` (64×64)<br>• `game/assets/sprites/player/boar_walk_{0..3}_x3.png` (128×128)<br>• `game/assets/sprites/player/poses/boar/` (6大戰鬥動作姿態目錄)<br>• `game/assets/sprites/portraits/boar.png` (128×128 HUD)<br>• `game/assets/sprites/portraits/boar_warrior.png` (對話框頭像)<br>• `game/assets/sprites/player/paperdoll/boar/` (7大部件切片) | • `game/assets/sprites/player/boar_idle.png` (64×64) | 官網英雄預覽、隊伍展示幀、戰鬥特寫姿態、行走動畫、戰鬥6大動作姿態目錄與 HUD 戰鬥頭像已全數產出齊全。 |
...
| `tiger` (烈焰虎) | • `docs/art/ember_tiger_concept.png` (928×1152 原畫)<br>• `branding/char_tiger.png` (400×840 立牌)<br>• `docs/art/char_tiger_candidate_400x840.png`<br>• `web/media/hero/char_tiger.png` (400×840 官網英雄圖)<br>• `web/media/hero/tiger_idle.png` (128×128 官網預覽圖)<br>• `game/assets/sprites/player/tiger_idle.png` (64×64)<br>• `game/assets/sprites/player/tiger_idle_x3.png` (128×128)<br>• `game/assets/sprites/player/party/tiger_idle.png` (128×128)<br>• `game/assets/sprites/player/tiger_battle.png` (128×128 戰鬥特寫姿態)<br>• `game/assets/sprites/player/tiger_walk_{0..3}.png` (64×64)<br>• `game/assets/sprites/player/tiger_walk_{0..3}_x3.png` (128×128)<br>• `game/assets/sprites/portraits/tiger.png` (128×128 HUD)<br>• `game/assets/sprites/portraits/ember_tiger.png` (384×480 對話框半身像)<br>• `game/assets/sprites/player/paperdoll/tiger/` (7大部件切片) | • `game/assets/sprites/player/poses/tiger/` (6大戰鬥動作姿態目錄) | 第6種族烈焰虎（Ember Tiger）官網立牌、HUD頭像、對話半身像、戰鬥特寫、行走動畫與紙娃娃切片已全數產出齊全；戰鬥6大動作姿態目錄由連動任務 t_a83b442c 處理。 |
