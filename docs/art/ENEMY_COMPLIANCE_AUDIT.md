...
>   - 主線首領：`t_2e6dee93`（雷歐改造初版，因 `t_6e8ee333` 總監頭部裁切放大複驗不合格列入黑名單）、`t_1402bdfb`（主線六域首領合規性專案盤點）、`t_9a23594e`（主線首領重繪批次1：wolf/fog）、`t_8de27f8b`（主線首領重繪批次2：abo/falcon/boar/demon 全數合規）  
...
| M1 | C1 王庭 | `leo` | 守衛泰坦·雷歐 | `web/media/bosses/signature/leo.png` | `proofs/enemy_audit/leo_v2_compare.png` | **有** (不合格) | **有** (不合格) | **無** (不合格) | ❌ **不合格** | **已重繪但複驗不合格（真實身份毛皮獅獸人，見 review.md 19g-10）**：`t_6e8ee333` 總監頭部裁切放大複驗，橘色蓬鬆鬃毛＋粉色腮紅＋生物臉孔＋無發條鑰匙，定性為穿重甲之毛皮獅獸人，嚴重違反 CANON 零毛皮鐵則，列入不可對外黑名單 |
...
> **主線首領盤點統計**：
> - 審查總數：7
> - **合格**：**6** 位（`wolf`、`fog`、`abo`、`falcon`、`boar`、`demon`，已 100% 重繪合規）
> - **不合格**：**1** 位（`leo` 守衛泰坦·雷歐，已重繪但複驗不合格，列入不可對外黑名單）
...
| 07 | `road_bandit` | 荒路匪徒 | `game/assets/sprites/bosses/road_bandit.png` | `proofs/enemy_audit/road_bandit_audit_panel.png` | **無** (合格) | **無** (合格) | **有** (合格) | ⚠️ **立繪合格但實機素材不可對外**<br>(t_f1fcef58 重繪；既有戰鬥影片/截圖多為舊版人類盜匪，未重錄前依 review 19g-10/19g-12 嚴禁對外) |
...
> **全體敵人／Boss 匯總統計 (18 隻)**：
> - 審查總數：18
> - **合格**：**17** 位（秘境小Boss 11 位 ＋ 主線區域首領 6 位；注意荒路匪徒既有實機錄影仍列不可對外）
> - **不合格（黑名單）**：**1** 位（守衛泰坦·雷歐 1 位在黑名單，真實身份毛皮獅獸人，見 review.md 19g-10）
...
- **三項問題答覆（review 19g-10 嚴格頭部裁切放大複驗，t_6e8ee333 總監覆核）**：
  - ① 毛髮質感：**有** (不合格)。橘色蓬鬆鬃毛，毛髮質感明顯，非金屬板件或齒輪。
  - ② 生物皮膚：**有** (不合格)。雙頰帶有粉色腮紅，一體成型之生物臉孔，非金屬沖壓板件。
  - ③ 發條鑰匙與螺栓：**無** (不合格)。頭部與背後無發條鑰匙，臉部與鬃毛上無任何螺栓、接縫、齒輪。
- **判定結果**：❌ **已重繪但複驗不合格（真實身份毛皮獅獸人，見 review.md 19g-10）**
- **0c-28 前後辨識度保留與重繪說明**：
  - **定性與違規事實**：定性為「穿重甲的獅子獸人」，僅身上鎧甲為金屬，內部仍為生物毛皮與血肉軀體，嚴重違反 CANON 零毛皮鐵則。
  - **審查結論**：依據 `references/review.md` 第 19g-10 條，守衛泰坦·雷歐已被正式列入**不可對外名單（黑名單）**。嚴禁將雷歐立繪、半身像、部位破壞截圖或戰鬥影片（如 `proofs/s8_loop_clip/` 系列、`mk_shorts_soul_battle_polish_30s.mp4`）作為對外行銷宣傳素材。未來任何人只看本文件亦不得誤判雷歐合規！
...
- **判定結果**：⚠️ **立繪重繪合格，但既有實機素材不可對外（見 review.md 19g-10 / 19g-12）**
- **說明**：本立繪資產已於任務 `t_f1fcef58` 重新繪製為發條玩具並合入 main。然而依據 `references/review.md` 第 19g-10 條（荒路匪徒為已知踩雷點，原版為人類盜匪）與第 19g-12 條（解禁的是那張立繪，不是所有拍到它的舊素材），repo 內現存既有實機短片（如五族打擊 18s 短片 `mk_shorts_five_races_combat_18s.mp4`）與戰鬥截圖仍含有舊版人類盜匪畫面。因此**既有含荒路匪徒之實機素材未重新錄製前一律列為不可對外名單**，行銷素材嚴禁選用！
...
### 🟢 允許對外發佈之合規敵人白名單 (Whitelist - 17 位合規)
#### 【主線區域首領 (6 位)】
1. **渣滓之狼 (`wolf`)**：已於 `t_9a23594e` 完成重繪，具備沖壓暗鐵板件、螺栓耳、金屬鋼板尾與背部黃銅發條鑰匙。
2. **白霧 (`fog`)**：已於 `t_9a23594e` 完成重繪，具備白瓷機巧狐面、齒輪薄片尾、紫金忍者裝與背部黃銅發條鑰匙。
3. **阿波 (`abo`)**：已於 `t_8de27f8b` 完成重繪，具備黑白生漆板件、金屬鉚釘圓盤耳、紅綾武術袍與背部八卦黃銅發條鑰匙。
4. **疾影 (`falcon`)**：已於 `t_8de27f8b` 完成重繪，具備紫晶金屬排片羽翼、黃銅機械啄、單眼光學瞄準鏡與背部螺旋推進發條鑰匙。
5. **石拳 (`boar`)**：已於 `t_8de27f8b` 完成重繪，具備厚重生鐵鑄鐵板件、金屬活塞排氣鼻、齒輪護頸、合金獠牙與背部十字黃銅發條鑰匙。
6. **停擺核 (`demon`)**：已於 `t_8de27f8b` 完成重繪，具備暗鐵魔王面甲、黑曜刀鋒翼、胸口停擺核心與背部王冠鐘錶發條鑰匙。

#### 【秘境小 Boss／雜魚 (11 位)】
7. **灰燼鼠 (`ash_rat`)**：已於 `t_63073ba4` 完成重繪，具備上漆白鐵皮與暗灰鐵板件、彈簧金屬尾與背部黃銅發條鑰匙。
8. **海岸掠奪者 (`coast_raider`)**：已於 `t_63073ba4` 完成重繪，具備牛角鐵盔、銅片玩具鬍、球形關節與背部黃銅發條鑰匙。
9. **迷霧暗影 (`fog_shade`)**：已於 `t_63073ba4` 完成重繪，具備鍛鐵兜帽、齒輪胸腔、格柵面甲與背部黃銅發條鑰匙。
10. **竹靈 (`bamboo_spirit`)**：已於 `t_b51e9456` 完成重繪，具備原木機巧面甲、拋光黃銅齒輪杖與背部黃銅齒輪發條鑰匙。
11. **森林精靈 (`forest_sprite`)**：已於 `t_b51e9456` 完成重繪，具備純白瓷面面甲、沖壓金屬綠葉髮型與背部雙環黃銅發條鑰匙。
12. **鏡中幽靈 (`mirror_wraith`)**：已於 `t_b51e9456` 完成重繪，具備威尼斯白瓷面具、紫靛金屬胸甲與鏡框側邊巨大黃銅發條鑰匙。
13. **黑焰領主 (`scar_lord`)**：已於 `t_0d32007c` 完成重繪，具備黑曜暗鐵板件、紫晶齒輪胸芯、雙鋸齒符文刃與背部黃銅發條鑰匙。
14. **黑焰幽火 (`scar_wisp`)**：已於 `t_0d32007c` 完成重繪，具備黃銅六角燈籠骨架、紫晶齒輪幽火、金屬機械爪與頂部黃銅發條鑰匙。
15. **下水道史萊姆 (`sewer_slime`)**：已於 `t_0d32007c` 完成重繪，具備半透明薄荷綠果凍體、體內咬合黃銅齒輪機芯、十字螺絲雙眼與頂部黃銅發條鑰匙。
16. **沉船船長 (`wreck_captain`)**：已於 `t_0d32007c` 完成重繪，具備風化木板拼裝身軀、金屬船舵帽徽、球形合頁關節與背部巨大黃銅船舵發條鑰匙。
17. **荒路匪徒 (`road_bandit`) [僅限單獨使用立繪]**：已於 `t_f1fcef58` 完成立繪重繪，具備金屬球形頭部、鐵皮胸甲與背部發條鑰匙。⚠️ **注意**：依 review.md 19g-10 與 19g-12 規範，既有實機錄影與截圖（如五族打擊 18s 短片）多為重繪前之舊版人類盜匪，**未重錄前含荒路匪徒之實機素材一律不可對外**！

---

### 🔴 嚴格禁止對外發佈之未合規黑名單 (Blacklist)
⛔ **雷歐 1 位在黑名單（不可對外名單）！與 `references/review.md 19g-10` 嚴格對齊：**

1. **守衛泰坦·雷歐 (`leo`) —— 核心黑名單**：
   - **原因**：經 `t_6e8ee333` 總監頭部裁切放大複驗，雷歐真實身份為「穿重甲的毛皮獅獸人」（橘色蓬鬆鬃毛、粉色腮紅、生物臉孔、無發條鑰匙），嚴重違反 CANON 零毛皮世界觀鐵則。
   - **禁令**：已被 `references/review.md` 第 19g-10 條明列為**不可對外名單**。嚴禁任何雷歐立繪、對話半身像、部位破壞戰鬥截圖（如 `proofs/combat/proof_battle_part_break.png`）或戰鬥短片（如 `proofs/s8_loop_clip/` 系列、`mk_shorts_soul_battle_polish_30s.mp4`）對外發布！
   - **狀態**：**雷歐 1 位在黑名單**。

2. **荒路匪徒 (`road_bandit`) —— 既有實機素材不可對外**：
   - **原因**：`review.md` 第 19g-10 條將其列為已知人類盜匪踩雷點；依 19g-12 條規範「解禁的是那張立繪，不是所有拍到它的舊素材」，既有五族戰鬥短片（`mk_shorts_five_races_combat_18s.mp4`）等實機素材仍含有舊版人類盜匪。
   - **禁令**：含荒路匪徒之既有實機截圖與影片一律不可對外，須待實機重新錄製並經 19g-10 複驗通過後方可解禁。

---

## 5. 重繪完成歷程與後續維護指引

依據世界觀憲章 CANON 與 review 19g-10 規範，全遊戲敵人立繪之重繪歷程如下：
- **秘境小Boss／雜魚 (11 位)**：
  - `t_f1fcef58`：荒路匪徒（立繪重繪，但既有實機素材未重錄前不可對外）
  - `t_63073ba4`（批次1）：灰燼鼠、海岸掠奪者、迷霧暗影
  - `t_b51e9456`（批次2）：竹靈、森林精靈、鏡中幽靈
  - `t_0d32007c`（批次3）：黑焰領主、黑焰幽火、下水道史萊姆、沉船船長
- **主線區域首領 (7 位)**：
  - `t_2e6dee93`：守衛泰坦·雷歐（C1，已重繪但 t_6e8ee333 複驗不合格，列入黑名單）
  - `t_9a23594e`（批次1）：渣滓之狼（C0）＋ 白霧（C2）
  - `t_8de27f8b`（批次2）：阿波（C3）＋ 疾影（C4）＋ 石拳（C5）＋ 停擺核（C6）

目前全遊戲敵人視覺資產中，已有 17 位立繪符合世界觀規範（其中荒路匪徒既有實機素材仍受限），**守衛泰坦·雷歐 1 位在黑名單（不可對外）**。行銷團隊選用素材前必須嚴格依據第 4 節白名單與黑名單核對，嚴防 19g-10 違規發布事故再次發生。
