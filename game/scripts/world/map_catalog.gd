...
static func _road() -> Dictionary:
	...
	m["entities"] = [
		...
		_e("bush_b", 1980, 230, 48, 40, "發條雜叢", Color(0.28, 0.3, 0.28)),
		_e("road_stone", 1692, 419, 40, 36, "裂開的路石", Color(0.4, 0.38, 0.36)),
		_e("camp_ash", 1080, 692, 56, 40, "過客熄火堆", Color(0.4, 0.3, 0.25)),
...
static func _crossroads() -> Dictionary:
	...
	var ents: Array = [
		...
		_e("path_mist_c", 2100, 1510, 72, 64, "南·白霧之地", Color(0.5, 0.55, 0.7)),
