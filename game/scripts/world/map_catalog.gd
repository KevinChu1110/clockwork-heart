...
static func _crossroads() -> Dictionary:
	...
	var ents: Array = [
		...
		_e("path_dojo_c", 1189, 64, 72, 64, "北·道場", Color(0.4, 0.55, 0.35)),
		_e("path_forest_c", 1640, 63, 72, 64, "東北·森林", Color(0.35, 0.55, 0.4)),
		_e("path_coast_c", 1640, 375, 72, 64, "東南·海岸", Color(0.4, 0.55, 0.65)),
		_e("path_tower_c", 1844, 141, 72, 64, "東·通天塔", Color(0.45, 0.35, 0.55)),
		_e("to_cross_north", 1108, 72, 64, 56, "北山道", Color(0.4, 0.5, 0.4)),
