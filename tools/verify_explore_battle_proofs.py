...
img_paths = [
    "proofs/explore_battle_no_128_fallback/proof_explore_rabbit_royal_parade_hd.png",
    "proofs/explore_battle_no_128_fallback/proof_battle_fox_astral_observer_hd.png"
]
...
for path in img_paths:
    ...
    # 0-QA21: 白方洞用量測
    # 統計角色中央區域 RGB 三通道皆 >= 250 的純白像素數
    center_rgb = arr[200:500, 200:750, :3]
