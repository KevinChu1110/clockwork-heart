#!/usr/bin/env python3
"""
verify_panda_poses.py
Comprehensive verification test suite for Porcelain Panda combat action poses (128x128 RGBA & 512x512 RGBA).
Mirrors verify_frog_poses.py, verify_elephant_poses.py, and verify_tortoise_poses.py.
"""
import os
import hashlib
...
POSES_DIR = f"{REPO_ROOT}/game/assets/sprites/player/poses/panda"
EXPECTED_SHADOW = [69, 67, 63, 55, 35, 0, 0, 0, 0, 0]
POSES = ['idle', 'attack', 'hit', 'recover', 'skill', 'telegraph']

print("=== VERIFYING PORCELAIN PANDA COMBAT POSES (128x128 & 512x512 RGBA) ===")
...
proof_768 = f"{REPO_ROOT}/game/assets/sprites/player/proof_panda_combat_poses_768.png"
proof_mag = f"{REPO_ROOT}/game/assets/sprites/player/proof_panda_combat_poses_magenta.png"
...
print("✓ Proof sheets verified (768x128 Transparent & Magenta)")

print("\n🎉 ALL QUALITY GATES PASSED FOR PORCELAIN PANDA COMBAT ACTION POSES!")
