...
func _process(_delta: float) -> bool:
	...
	match _step:
		...
		1:
			...
			img.save_png("/opt/side/bravesoul-game/proofs/proof_equip_panel_top_zh_TW.png")
			print("Saved /opt/side/bravesoul-game/proofs/proof_equip_panel_top_zh_TW.png")
		...
		2:
			if _wait < 10:
				return false
			var img := root.get_texture().get_image()
			img.save_png("/opt/side/bravesoul-game/proofs/proof_equip_panel_scrolled_zh_TW.png")
			print("Saved /opt/side/bravesoul-game/proofs/proof_equip_panel_scrolled_zh_TW.png")
			quit(0)
			return true
	return false
