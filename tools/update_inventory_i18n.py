...
ENTRIES = {
    ...
    "道具與戰魂倉庫 · 點選格子查看詳情": {
        "zh_TW": "道具與戰魂倉庫 · 點選格子查看詳情",
        "zh_CN": "道具与战魂仓库 · 点击格子查看详情",
        "en": "Item & Soul Storage · Tap slot to view details",
        "ja": "道具と戦魂の倉庫 · マスをタップして詳細確認",
        "ko": "아이템 및 전혼 보관소 · 슬롯을 눌러 상세 확인",
        "es": "Almacén de objetos y almas · Toca una casilla para ver detalles",
    },
    "點選格子查看詳情 · 雙擊或點擊按鈕使用": {
        "zh_TW": "點選格子查看詳情 · 雙擊或點擊按鈕使用",
        "zh_CN": "点击格子查看详情 · 双击或点击按钮使用",
        "en": "Tap slot to view details · Double-tap or press button to use",
        "ja": "マスをタップして詳細確認 · ダブルタップまたはボタンで使用",
        "ko": "슬롯을 눌러 상세 확인 · 더블 탭 또는 버튼을 눌러 사용",
        "es": "Toca una casilla para ver detalles · Pulsa dos veces o usa el botón para usar",
    },
    "使用道具": {
        "zh_TW": "使用道具",
        "zh_CN": "使用道具",
