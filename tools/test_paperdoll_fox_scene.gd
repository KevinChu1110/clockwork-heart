extends SceneTree
## 《發條之心》紙娃娃狐族場景節點 (PaperdollCharacter) 無頭自動化測試
## 執行方式：godot --path game --headless -s ../tools/test_paperdoll_fox_scene.gd

const PaperdollRenderer = preload("res://scripts/art/paperdoll_renderer.gd")
const PaperdollCharacter = preload("res://scripts/art/paperdoll_character.gd")
const PROOF_OUTPUT_PATH := "res://assets/sprites/player/paperdoll/fox/proof_paperdoll_fox_composite.png"


func _initialize() -> void:
	var ok := true
	print("=== 開始狐族紙娃娃實際場景節點測試 (PaperdollCharacter - fox) ===")
	...
	if composite_img == null or composite_img.is_empty():
		...
		# 斷言：合成圖絕非空白或全透明（完整 7 層狐族角色應有超過 1000 像素）
...
func _finish(ok: bool) -> void:
	print("\n=======================================================")
	if ok:
		print("FOX_PAPERDOLL_SCENE_OK")
		quit(0)
	else:
		print("FOX_PAPERDOLL_SCENE_FAIL")
		quit(1)
