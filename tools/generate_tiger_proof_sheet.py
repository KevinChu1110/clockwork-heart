#!/usr/bin/env python3
"""
generate_tiger_proof_sheet.py
Creates a composite 3x2 preview sheet with labels of the 6 Ember Tiger combat action poses
for visual inspection and verification.
"""
...
PROOF_PATH = f"{REPO_ROOT}/game/assets/sprites/player/proof_tiger_combat_poses_640.png"
PROOF_MAGENTA = f"{REPO_ROOT}/game/assets/sprites/player/proof_tiger_combat_poses_magenta.png"
