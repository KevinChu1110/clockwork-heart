#!/usr/bin/env python3
"""
verify_crane_poses.py
Comprehensive verification test suite for Cloud Crane combat action poses (128x128 RGBA).
Mirrors verify_tiger_poses.py and verify_lion_poses.py.
"""
import os
import hashlib
...
EXPECTED_SHADOW = [46, 48, 54, 53, 53, 51, 47, 19, 0, 0]
POSES = ['idle', 'attack', 'hit', 'recover', 'skill', 'telegraph']
lut = [0] * 11 + [1] * 245

print("=== VERIFYING CLOUD CRANE COMBAT POSES (128x128 RGBA) ===")
