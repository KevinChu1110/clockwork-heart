...
base = "game/assets/sprites/player/paperdoll/macaque"

# test each layer separately
slots = [
    ("winding_key", f"{base}/winding_key/key_classic_brass.png"),
    ("back_curio", f"{base}/back_curio/curio_spring_tail.png"),
    ("chassis", f"{base}/chassis/paint_ivory_stock.png"),
    ("head_unit", f"{base}/head_unit/ear_macaque_coaxial.png"),
    ("costume", f"{base}/costume/costume_dawn_monk_tunic.png"),
    ("optic_core", f"{base}/optic_core/core_cyan_emerald.png"),
    ("weapon", f"{base}/weapon/wpn_spring_claws.png")
]
...
for sname, spath in slots:
    ...
    measure_im(comp, f"After adding {sname}")
