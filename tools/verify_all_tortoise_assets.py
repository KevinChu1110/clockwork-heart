#!/usr/bin/env python3
"""
verify_all_tortoise_assets.py
Comprehensive verification script for Xuanji Tortoise official assets suite.
Matches test patterns from verify_all_tiger_assets.py and verify_all_crane_bear_assets.py.
"""
...
def verify():
    print("=== VERIFYING ALL XUANJI TORTOISE OFFICIAL ASSETS ===")
    all_ok = True

    required_assets = [
        # Category 1: 官網英雄圖 / 品牌立牌
        ("branding/char_tortoise.png", [(400, 840), (800, 1680), (1344, 1680)], ["RGB", "RGBA"]),
        ("web/media/hero/char_tortoise.png", [(400, 840), (1344, 1680)], ["RGB", "RGBA"]),
        ("docs/art/char_tortoise_candidate_400x840.png", (400, 840), ["RGB", "RGBA"]),
        ("docs/art/xuanji_tortoise_concept.png", None, ["RGB", "RGBA"]),
        
        # Category 2: 戰鬥特寫
        ("game/assets/sprites/player/tortoise_battle.png", (128, 128), ["RGBA"]),
        
        # Category 3: 行走動畫
        ("game/assets/sprites/player/tortoise_walk_0.png", (64, 64), ["RGBA"]),
        ("game/assets/sprites/player/tortoise_walk_1.png", (64, 64), ["RGBA"]),
        ("game/assets/sprites/player/tortoise_walk_2.png", (64, 64), ["RGBA"]),
        ("game/assets/sprites/player/tortoise_walk_3.png", (64, 64), ["RGBA"]),
        ("game/assets/sprites/player/tortoise_walk_0_x3.png", (128, 128), ["RGBA"]),
        ("game/assets/sprites/player/tortoise_walk_1_x3.png", (128, 128), ["RGBA"]),
        ("game/assets/sprites/player/tortoise_walk_2_x3.png", (128, 128), ["RGBA"]),
        ("game/assets/sprites/player/tortoise_walk_3_x3.png", (128, 128), ["RGBA"]),
        
        # Mirror idle assets
        ("game/assets/sprites/player/tortoise_idle.png", (64, 64), ["RGBA"]),
        ("game/assets/sprites/player/tortoise_idle_x3.png", (128, 128), ["RGBA"]),
        ("game/assets/sprites/player/party/tortoise_idle.png", (128, 128), ["RGBA"]),
        ("web/media/hero/tortoise_idle.png", (128, 128), ["RGBA"]),
        
        # Category 4: HUD 戰鬥頭像 與 對話框半身像
        ("game/assets/sprites/portraits/tortoise.png", (128, 128), ["RGBA"]),
        ("game/assets/sprites/portraits/xuanji_tortoise.png", (384, 480), ["RGBA"]),
    ]
    ...
    standee = Image.open(f"{BRANDING_DIR}/char_tortoise.png")
    ...
    base_idle = Image.open(f"{PLAYER_DIR}/tortoise_idle_x3.png").convert("RGBA")
    w_x3 = [Image.open(f"{PLAYER_DIR}/tortoise_walk_{i}_x3.png").convert("RGBA") for i in range(4)]
    w_64 = [Image.open(f"{PLAYER_DIR}/tortoise_walk_{i}.png").convert("RGBA") for i in range(4)]
    ...
    for i in range(4):
        for dx in range(-8, 9):
            for dy in range(-8, 9):
                ...
                if diff is None:
                    ...
                    all_ok = False
        print(f"  ✓ tortoise_walk_{i}_x3 passed 4b-4: guaranteed not pure translation under any offset")
        ...
        if min_diff <= 300:
            ...
            print(f"  ✓ tortoise_walk_{i}_x3 passed 4b-7: articulation diff={min_diff}px > 300px")
    ...
    for i in range(4):
        ...
        if f_shadow != base_shadow:
            ...
            print(f"  ✓ tortoise_walk_{i}_x3 passed 4b-5: shadow row counts {f_shadow} 100% match idle baseline")

    # 5. Rule 4b-6: Battle Sprite
    print("\n--- [5/6] Rule 4b-6 Battle Sprite Metrics ---")
    battle = Image.open(f"{PLAYER_DIR}/tortoise_battle.png").convert("RGBA")
    ...
    hud = Image.open(f"{PORTRAITS_DIR}/tortoise.png").convert("RGBA")
    h_bbox = hud.getbbox()
    ...
    bust = Image.open(f"{PORTRAITS_DIR}/xuanji_tortoise.png").convert("RGBA")
    ...
    if all_ok:
        print("\n🎉 ALL VERIFICATION CHECKS PASSED FOR XUANJI TORTOISE!")
        return True
    else:
        print("\n❌ SOME CHECKS FAILED!")
        return False
