...
def generate_chassis_comparison():
    # 3 Chassis variants on Nutcracker Guard costume
...
def generate_costume_comparison():
    ...
    items = [
        ...
        (c_art, "蒸氣工匠 [新]", "Steam Artisan", True)
    ]
...
def generate_verification_crops():
    ...
    # Region around chest/suspenders: X[40..86], Y[65..105]
    ...
    # Region around chest/joints: X[45..86], Y[55..95]
