extends SceneTree
## QA Round 23: 大廳全景六語系切換實機截圖腳本
## 執行方式：xvfb-run -a godot --path game --rendering-driver opengl3 -s res://../tools/capture_qa_round23.gd

const FRAMES := 8
const OUT_DIR := "/opt/side/bravesoul-game/proofs/qa_round23"
...
func _initialize() -> void:
	...
	print("── 開始執行 QA Round 23 大廳全景六語系實機截圖 ──")
