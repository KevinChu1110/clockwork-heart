#!/usr/bin/env python3
"""
tools/audit_md5_rabbit_penguin.py
Audits MD5 hashes across all head_unit files for Rabbit and Penguin.
...
def main():
    print("====================================================================================================")
    print("【驗收查重】兔族與蒸氣企鵝族 head_unit 全量切片 MD5 排序與唯一性查核 (0-ART28n / 0-ART28q)")
    print("====================================================================================================")
    
    known_base_aliases = {
        ("penguin", "head_steam_penguin_navy_512.png"): "head_steam_penguin_stock_512.png",
    }
    ...
    for race in RACES:
        ...
        for fname, h in file_hashes:
            ...
            if len(dup_list) == 1:
                ...
                if (race, fname) in known_base_aliases:
    ...
    print("\n" + "=" * 100)
    if all_clean:
        print("🎉 MD5 查重通過！兔族與蒸氣企鵝族所有切片皆為唯一獨立或符合已知共用 base 設計。")
    else:
