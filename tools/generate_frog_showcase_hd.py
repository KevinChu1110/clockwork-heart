...
def process_frog_showcase():
    src_path = "branding/char_frog.png"
    dst_path = "game/assets/sprites/player/showcase/frog_idle_hd.png"
    ...
    print(f"Processing frog ({w}x{h}): bg_mean={bg_mean.astype(int).tolist()}")
