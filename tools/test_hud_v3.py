...
# Crop from upper key y=60 down to lower chest y=320, x=50..360
crop = bust_512.crop((50, 60, 360, 320))
cw, ch = crop.size
print("Bust crop size:", crop.size, "bbox:", crop.getbbox())

# Scale to fit 104px height inside 128x128
target_h = 104.0
scale = target_h / ch
...
hud.save("/tmp/tortoise_hud_v3.png")
print("Saved /tmp/tortoise_hud_v3.png, bbox:", hud.getbbox())
