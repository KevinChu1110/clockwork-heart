...
pd_dir = f"{root}/game/assets/sprites/player/paperdoll/penguin"
comp_path = f"{pd_dir}/proof_paperdoll_penguin_composite.png"
mag_path = f"{pd_dir}/proof_paperdoll_penguin_magenta.png"
out_path = f"{pd_dir}/proof_paperdoll_penguin_compare.png"

comp_img = Image.open(comp_path).convert("RGBA")
# For magenta, we can take comp_img and put it directly on magenta card!
scale = 2
...
font_title = ImageFont.truetype("/usr/share/fonts/opentype/ipafont-gothic/ipag.ttf", 16)

# Title banner
title_text = "STEAM PENGUIN · PAPERDOLL ASSEMBLY & MAGENTA PROOF"
sub_text = "第九族 蒸氣企鵝 · 紙娃娃 7 槽裝配與洋紅底板去背驗收"
...
# Inside card 2, create a clean magenta rounded sub-card for the sprite
...
# Draw neat border around the magenta proof frame
