...
print(f"Candidate attack v2: full_bbox={cand.getbbox()} | body(y<118) bbox=({min_x}, {min_y}, {max_x}, {max_y}) height={h}")

print("\n--- Diff Matrix: candidate attack v2 vs other poses & fox_battle ---")
