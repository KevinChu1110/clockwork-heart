...
base_dir = "/opt/side/bravesoul-game/game/assets/sprites/player/poses/macaque"
...
for p in poses:
    ...
    print(f"macaque {p}: size={img.size}, bbox={img.getbbox()}, diff_from_idle_bbox={bbox}, diff_pixels={diff_px}")
