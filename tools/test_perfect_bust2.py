...
# Crop from top of key y=55 down to waistline y=390 (completely omitting pelvis and legs)
crop = bust.crop((45, 55, 425, 390))
cw, ch = crop.size
...
dialogue_bust.save("/tmp/test_dialogue_bust_perfect2.png")
print("Saved /tmp/test_dialogue_bust_perfect2.png, bbox:", dialogue_bust.getbbox())
